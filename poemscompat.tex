...
% Implementation command (not for direct use in documents): If the argument is
% non-empty, insert a line break and print that the argument is an ISBN-10,
% but if it is empty do nothing.
\newcommand{\isbnten}[1]{\if\relax #1 \relax\else \\ISBN-10: #1 \fi}
