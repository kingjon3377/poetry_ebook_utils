...
\poemscompat{%
	...
	\newcommand{\@starredsequencesectiontitle}[1]{\thispagestyle{empty}\subsection{#1}}%
	\newcommand{\@sequencesectiontitle}[1]{\thispagestyle{empty}\subsection{#1}\addcontentsline{top}{subsection}{#1}}%
